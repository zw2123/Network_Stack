...
entity packet_handler_start_for_ethernet_remover_U0 is 
    generic (
...
architecture rtl of packet_handler_start_for_ethernet_remover_U0 is

    component packet_handler_start_for_ethernet_remover_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_packet_handler_start_for_ethernet_remover_U0_ShiftReg : packet_handler_start_for_ethernet_remover_U0_ShiftReg
    generic map (
...
entity packet_handler_start_for_ethernet_remover_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end packet_handler_start_for_ethernet_remover_U0_ShiftReg;

architecture rtl of packet_handler_start_for_ethernet_remover_U0_ShiftReg is
